...
int main()
{
    //ProtonFitter fit(50,37,20,15,18,58,56,52);    
    //ProtonFitter fit(51, 46, 38, 2, 25, 4, 18, 58, 55 ,52);
    ProtonFitter fit(50, 46, 38, 2, 25, 4, 18, 58, 55 ,52);
    fit.SetNextNeutronFit_BC501A(49);
    fit.SetNextNeutronFit_BC501A(48);
    fit.SetNextNeutronFit_BC501A(47);
